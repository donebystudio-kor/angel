// English batch 29 — a new English-original family: "AAAB"/"BAAA"
// four-digit numbers, three of one digit plus one different digit.
// Read consistently: AAAB (three A's then B) means an already-
// saturated theme now opening toward a new, emerging one; BAAA (B
// first, then three A's) means a single trigger igniting an
// overwhelming wave of the tripled theme. This batch covers the
// self/new-beginning family (1112-1119, 2111-9111) and starts the
// completion family (9112-9115).
// Isolated from the Korean dataset — an English-only extension not
// drawn from ANGEL_NUMBERS. Safe to delete this file (and remove its
// import in angels.en.ts) to roll back just this batch.
...
export const EN_BATCH29_NUMBERS: EnAngelNumber[] = [
  ...
  },
  {
    ...
    spiritual: "This favors recognizing when inward growth has produced real creative material, worth expressing rather than keeping entirely private.",
    action: "Channel one piece of self-focused insight into a creative expression today.",
    category: "repeat",
    faq: [
      {
  ...
  },
  {
    ...
    distinction:
      "4111 doesn't share its territory with 411 the way it might first appear to. 411 pairs foundation with a doubled 1, heightened intuition arriving as a specific, actionable piece of information, closer to a nudge than a surge. 4111's tripled 1 is a different order of intensity: not one insight landing, but a wave of new-beginning energy being unleashed all at once. Seeing 411 usually calls for paying attention to one specific thing that just reached you; seeing 4111 calls for tracing an entire flood of motivation back to what triggered it.",
    context:
      "If 4111 shows up right after something in your life visibly settled, a decision made, a move completed, a plan finalized, the reading is straightforward: that settling is the spark. It's less obvious when the stability isn't a recent event but something you've been standing on for a while without noticing, a long-held routine, a relationship you stopped actively appreciating. In that case, 4111 is asking you to locate a less visible form of stability, not necessarily a recent one, as the source of the current surge.",
    misconception:
      "Because 111 is the more visually dominant, more commonly recognized part of this number, it's easy to read 4111 as essentially 1111 with a stray 4 in front of it, treating the foundation digit as incidental. The position argues against that: the 4 comes first and functions as the trigger, not decoration. Drop it and the number describes energy appearing out of nowhere; keep it and the energy has a traceable source.",
    origin:
      "Unity for 1 and structure for 4 both have long-standing individual footholds in general numerology, predating the angel-number framing. The specific reading of 4111 as stability triggering a burst of new-beginning energy isn't traceable to one identifiable source, though; it fits the pattern-based, combination-driven interpretive style associated with modern angel-number writing rather than older single-digit numerology, which doesn't typically build multi-step causal narratives out of digit order.",
  },
  {
    number: "5111",
